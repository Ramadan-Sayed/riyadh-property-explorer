import { PropertyFeature } from '../../../core/models/property.model.js';
...
export class PropertyDetailsComponent {
  ...
  public render(property: PropertyFeature | null, onZoom?: (coords: [number, number]) => void, onClose?: () => void): void {
    ...
    let leafletCoords: [number, number] = [0, 0];
    ...
    document.getElementById('btn-zoom-property')?.addEventListener('click', () => {
      if (onZoom && leafletCoords[0] !== 0) onZoom(leafletCoords);
    });
  }
}